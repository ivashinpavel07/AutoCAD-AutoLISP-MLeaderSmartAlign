...
## 🎞 Demo — MLeaderSmartAlign v0.7

The main demo below shows the complete v0.7 workflow in one command: **linear Live Preview + optional Live Perimeter**.

[![MLeaderSmartAlign v0.7 — Line + Perimeter](images/MLeaderSmartAlign_v07.gif)](images/MLeaderSmartAlign_v07.gif)

➡️ [Open the v0.7 GIF in full size](images/MLeaderSmartAlign_v07.gif)

🎬 **YouTube — v0.7 development process + live AutoCAD test:**  
https://youtu.be/nRvsLB-oLcI

The video shows the ChatGPT-assisted creation of `MLeaderSmartAlign_v07.lsp` and then a real test of the resulting command in AutoCAD.

### Evolution of the tool

The two demos below show the earlier stages that were later combined into v0.7.

**1. Line SmartAlign — predecessor of the LIVE LINE stage**

[![MLeaderSmartAlign line alignment](images/example.gif)](images/example.gif)

**2. Perimeter — predecessor of the LIVE PERIMETER stage**
...
Главная демонстрация v0.7 — `images/MLeaderSmartAlign_v07.gif`: в ней показаны оба режима в одном непрерывном workflow — линейное распределение и переход к распределению по периметру.
...
The primary v0.7 demo is `images/MLeaderSmartAlign_v07.gif`: it shows both modes in one continuous workflow — line distribution followed by optional perimeter distribution.
